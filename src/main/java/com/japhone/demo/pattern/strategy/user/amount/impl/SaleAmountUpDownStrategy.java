 ...
 */
@Component
@HandlerUpDownLevelConditionType(LevelConditionEnum.SALES_AMOUNT)
public class SaleAmountUpDownStrategy extends AbstractAmountUpDownStrategy {
    @Resource
    ...
    public BigDecimal getValue(Long userId) {
         ...
         * 从数据库中检索当前用户的消费额
         */
        UserAmount userAmount = userAmountService.queryByUserIdAndAmountType(userId, AmountTypeEnum.SALES_VALUE.getCode());
