 ...
 */
@Component
@HandlerUpDownLevelConditionType(LevelConditionEnum.CONSUMPTION_AMOUNT)
public class ConsumeAmountUpDownStrategy extends AbstractAmountUpDownStrategy {
    ...
    public BigDecimal getValue(Long userId) {
         ...
         * 从数据库中检索当前用户的消费额
         */
        UserAmount userAmount = userAmountService.queryByUserIdAndAmountType(userId, AmountTypeEnum.CONSUMPTION.getCode());
