 ...
 */
@Component
@HandlerUpDownLevelConditionType(LevelConditionEnum.SETTLEMENT_GROWTH_VALUE)
public class SettlementGrowthUpDownStrategy extends AbstractGrowthUpDownStrategy {
    @Override
